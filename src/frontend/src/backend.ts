...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: ProductInput): Promise<string> {
        if (this.processError) {
            try {
    ...
    async deleteProducts(arg0: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteProducts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMonthlySpend(): Promise<Array<MonthlySpend>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlySpend();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProducts(arg0: ProductFilter): Promise<ProductPage> {
        if (this.processError) {
            try {
    ...
    async getStatusDistribution(): Promise<Array<StatusDistribution>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStatusDistribution();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: string, arg1: ProductInput): Promise<boolean> {
        if (this.processError) {
            try {
